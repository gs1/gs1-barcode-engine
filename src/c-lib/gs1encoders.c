...
#define test_getScanData(c, n, d, e) do {					\
	do_test_getScanData(c, #n, gs1_encoder_s##n, d, e);			\
} while (0)

static void do_test_getScanData(gs1_encoder* ctx, char* name, int sym, char* dataStr, char* expect) {
...
void test_api_getScanData(void) {
	...
	test_getScanData(ctx, NONE, "", "");
	test_getScanData(ctx, NONE, "TESTING", "");

	/* QR */
	test_getScanData(ctx, QR, "TESTING", "]Q0TESTING");
	test_getScanData(ctx, QR, "\\#TESTING", "]Q0#TESTING");			// Escaped data "#" character
	test_getScanData(ctx, QR, "\\\\#TESTING", "]Q0\\#TESTING");		// Escaped data "\#" characters
	test_getScanData(ctx, QR, "#011231231231233310ABC123#99TESTING",
		"]Q3011231231231233310ABC123" "\x1D" "99TESTING");

	/* DM */
	test_getScanData(ctx, DM, "TESTING", "]d1TESTING");
	test_getScanData(ctx, DM, "\\#TESTING", "]d1#TESTING");			// Escaped data "#" character
	test_getScanData(ctx, DM, "\\\\#TESTING", "]d1\\#TESTING");		// Escaped data "\#" characters
	test_getScanData(ctx, DM, "#011231231231233310ABC123#99TESTING",
		"]d2011231231231233310ABC123" "\x1D" "99TESTING");
	test_getScanData(ctx, DM, "#011231231231233310ABC123#99TESTING#",
		"]d2011231231231233310ABC123" "\x1D" "99TESTING");		// Trailing FNC1 should be stripped

	/* DataBar Expanded */
	test_getScanData(ctx, DataBarExpanded, "#011231231231233310ABC123#99TESTING",
		"]e0011231231231233310ABC123" "\x1D" "99TESTING");
	test_getScanData(ctx, DataBarExpanded, 					// ... Variable-length AI | Composite
		"#011231231231233310ABC123#99TESTING|#98COMPOSITE#97XYZ",
		"]e0011231231231233310ABC123" "\x1D" "99TESTING" "\x1D" "98COMPOSITE" "\x1D" "97XYZ");
	test_getScanData(ctx, DataBarExpanded,					// ... Fixed-Length AI | Composite
		"#011231231231233310ABC123#11991225|#98COMPOSITE#97XYZ",
		"]e0011231231231233310ABC123" "\x1D" "1199122598COMPOSITE" "\x1D" "97XYZ");

	/* GS1-128 */
	test_getScanData(ctx, GS1_128_CCA, "#011231231231233310ABC123#99TESTING",
		"]C1011231231231233310ABC123" "\x1D" "99TESTING");
	test_getScanData(ctx, GS1_128_CCA,					// Composite uses ]e0
		"#011231231231233310ABC123#99TESTING|#98COMPOSITE#97XYZ",
		"]e0011231231231233310ABC123" "\x1D" "99TESTING" "\x1D" "98COMPOSITE" "\x1D" "97XYZ");

	/* DataBar OmniDirectional */
	test_getScanData(ctx, DataBarOmni, "#0124012345678905|#99COMPOSITE#98XYZ",
		"]e0012401234567890599COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, DataBarOmni, "24012345678905|#99COMPOSITE#98XYZ",
		"]e0012401234567890599COMPOSITE" "\x1D" "98XYZ");

	/* DataBar Limited */
	test_getScanData(ctx, DataBarLimited, "#0115012345678907|#99COMPOSITE#98XYZ",
		"]e0011501234567890799COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, DataBarLimited, "15012345678907|#99COMPOSITE#98XYZ",
		"]e0011501234567890799COMPOSITE" "\x1D" "98XYZ");

	/* UPC-A */
	test_getScanData(ctx, UPCA, "#0100416000336108|#99COMPOSITE#98XYZ",
		"]E00416000336108|]e099COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, UPCA, "416000336108|#99COMPOSITE#98XYZ",
		"]E00416000336108|]e099COMPOSITE" "\x1D" "98XYZ");

	/* UPC-E */
	test_getScanData(ctx, UPCE, "#0100001234000057|#99COMPOSITE#98XYZ",
		"]E00001234000057|]e099COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, UPCE, "001234000057|#99COMPOSITE#98XYZ",
		"]E00001234000057|]e099COMPOSITE" "\x1D" "98XYZ");

	/* EAN-13 */
	test_getScanData(ctx, EAN13, "#0102112345678900|#99COMPOSITE#98XYZ",
		"]E02112345678900|]e099COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, EAN13, "2112345678900|#99COMPOSITE#98XYZ",
		"]E02112345678900|]e099COMPOSITE" "\x1D" "98XYZ");

	/* EAN-8 */
	test_getScanData(ctx, EAN8, "#0100000002345673|#99COMPOSITE#98XYZ",
		"]E402345673|]e099COMPOSITE" "\x1D" "98XYZ");
	test_getScanData(ctx, EAN8, "02345673|#99COMPOSITE#98XYZ",
		"]E402345673|]e099COMPOSITE" "\x1D" "98XYZ");
